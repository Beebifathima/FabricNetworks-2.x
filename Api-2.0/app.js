...
app.get('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
    try {
        ...
        res.send(response_payload);
            ...
            const message = JSON.stringify({ username: req.username, id: userIPAddress });
            console.log("Message:", message);
            let response = await invoke.invokeTransaction(channelName, chaincodeName, "DangerUser", args, req.username, req.orgname);
            res.send(response_payload);
        }
