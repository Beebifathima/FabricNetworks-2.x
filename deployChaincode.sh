...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
        -c '{"function": "CreateDomain","args": ["{\"IP\":\"192.168.0.5\",\"URL\":\"world.com\",\"IdentityProofs\":{\"idno\":\"8651458452\",\"comno\":\"298549854568\"}}"]}'
}
...
invokeDangerUser() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA \
        -c '{"function": "DangerUser","args": ["{\"username\":\"vamshi\",\"id\":\"95687456985\"}"]}'
}
...
chaincodeQuery() {
    setGlobalsForPeer0Org1
    # setGlobalsForOrg1
    peer chaincode query -C $CHANNEL_NAME -n ${CC_NAME} -c '{"function": "GetIPAddressByURL","Args":["world.com"]}'
}
# chaincodeQuery
